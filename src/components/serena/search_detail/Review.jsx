        ...
        <section key={index} className="flex flex-col relative shrink-0 box-border mt-5">
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            <div className="flex flex-col items-stretch w-full max-md:w-full max-md:ml-0">
              ...
              <div className="flex text-area flex-col relative shrink-0 box-border border h-[250px] w-[700px] text-lg mt-5 mx-auto p-2.5 rounded border-solid border-stone-300 max-sm:w-[300px]">
                {review.content}
              </div>
            </div>
          </div>
