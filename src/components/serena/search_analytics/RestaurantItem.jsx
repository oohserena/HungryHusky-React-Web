            ...
            <div className="flex flex-col relative shrink-0 box-border border mt-5 border-none">
              <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                <div className="flex flex-col items-stretch w-[33%] max-md:w-full max-md:ml-0">
                  <div
                    className="relative shrink-0 box-border h-auto font-semibold text-xl text-center ml-8 mt-5"
                    style={{ fontSize: "1.5em" }}
                  >
                    Rating Distribution
                  </div>
                  <div
                    className="relative shrink-0 box-border h-auto text-xl font-semibold text-red-700 text-center ml-8 mt-5"
                    style={{ fontSize: "2em" }}
                  >
                    5 stars: {ratingFiveCount}
                  </div>
                  <div
                    className="relative shrink-0 box-border h-auto text-xl font-semibold text-orange-500 text-center ml-8 mt-5"
                    style={{ fontSize: "2em" }}
                  >
                    4 stars:{ratingFourCount}
                  </div>
                  <div
                    className="relative shrink-0 box-border h-auto text-xl font-semibold text-amber-500 text-center ml-8 mt-5"
                    style={{ fontSize: "2em" }}
                  >
                    3 stars:{ratingThreeCount}
                  </div>
                  <div
                    className="relative shrink-0 box-border h-auto text-xl font-semibold text-yellow-400 text-center ml-8 mt-5"
                    style={{ fontSize: "2em" }}
                  >
                    2 stars:{ratingTwoCount}
                  </div>
                  <div
                    className="relative shrink-0 box-border h-auto text-xl font-semibold text-lime-500 text-center ml-8 mt-5"
                    style={{ fontSize: "2em" }}
                  >
                ...
                <div className="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
                  <div
                    className="relative shrink-0 box-border h-auto text-xl font-semibold text-center mt-5"
                    style={{ fontSize: "2em" }}
                  >
                    Reviews
                  </div>
                  <div
                    className="relative shrink-0 box-border h-auto text-center text-3xl text-red-700 font-semibold mt-5"
